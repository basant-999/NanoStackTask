...
import ActionBar from "./Action.jsx";
import ActionItems from "./ActionItem.jsx";

const BuyerMeetingList = () => {
                ...
                <tr>
                  ...
                  <th>
                    <div className="TheadItem">
                      Date & Time <div><MdKeyboardArrowUp /><MdKeyboardArrowDown /></div>
                    </div>
                  </th>
                  <th>
                    <div className="TheadItem">
                      Status <div><MdKeyboardArrowUp /><MdKeyboardArrowDown /></div>
                    </div>
                  </th>
...
export default BuyerMeetingList;
